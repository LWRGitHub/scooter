...
const Info = () => (
    <div >
        ...
        <div className="m-0 p-3 pb-0" id="scoot1" >
            <img src='images/scooter-dimentions.jpeg' />
        </div>
       ...
       <div className="m-0" id="scoot1" style={{backgroundColor: "#f3f3f3"}}>
        ...
        <div className="" style={{textAlign: "center", backgroundColor: "black"}}>
            <br />
            <p style={{fontSize: "13px", color: '#990033'}}>Ultra-bright headlights</p>
            <br />
            <p className="mx-5 px-5 mb-0 pb-4 text-white" style={{fontSize: "11px", maxWidth: '1000px'}}>Headlights are essential for night riding, yet not all scooters have them. Mi Electric Scooter features an ultra-bright 1.1W headlights with a range of up to 6 meters for added safety.</p>
        </div>
        ...
        <div className="" style={{textAlign: "center", backgroundColor: "black"}}>
            <br />
            <p style={{fontSize: "13px", color: '#990033'}}>Red taillights for braking | Front and rear double braking system</p>
            <br />
            <p className="mx-5 px-5 mb-0 pb-4 text-white" style={{fontSize: "11px", maxWidth: '1000px'}}>Red taillights flash distinctly while braking as a warning to other pedestrians and vehicles on the road. Features a disc braking and eABS regenerative anti-lock braking system for an efficient, responsive braking distance of just 13.1 ft.</p>
        </div>
        <div className="" id="scoot1" >
        ...
        <div style={{textAlign: "center"}}>
            <br />
            <p style={{fontSize: "13px", color: '#990033'}}>Shock-absorbing tires for a smoother ride</p>
            <br />
            <p className="mx-5 px-5" style={{fontSize: "11px", maxWidth: '1000px'}}>The large 8.5-inch front and rear tires have great shock absorption and anti-slip treads. Coupled with a 250W brushless DC motor for stable power output, Mi Electric Scooter is set to deliver a smoother riding experience.</p>
        </div>
        ...
        <div className="" style={{textAlign: "center", backgroundColor: "black"}}>
            <br />
            <p style={{fontSize: "13px", color: '#990033'}}>18.6 miles long-range battery with smart power management</p>
            <br />
            <p className="mx-5 px-5 mb-0 pb-3 text-white" style={{fontSize: "11px", maxWidth: '1000px'}}>Several 18650 high-capacity lithium batteries deliver up to 18.6 miles of travel on a single charge. Smart battery management via the app displays the health of the battery pack and notifies you immediately if there are issues.</p>
            ...
            <div class="row">
                ...
                <div class="col-6 mr-1  text-white" >
                    <ul className="p-2" style={{position: "absolute", fontSize: "11px", listStyleType: "none"}}>
                        <li style={{paddingTop: "170px"}}>Short circuit protection</li>
                        <li>Overcurrent protection</li>
                        <li>Double protection from overcharging</li>
                        <li>Double protection from overdischarging</li>
                        <li>Temperature Resistance</li>
